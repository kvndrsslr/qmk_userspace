 ...
 *                                                                      generated by [keymapviz] */
    ...
    _______       ,      _______       ,      _______       ,   _______       ,  _______       ,   _______       ,      _______       ,                                                      _______       ,            KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       MS_BTN3,     _______       ,
    ...
    _______       , _______       , _______       , _______       ,    _______       ,    _______       ,                                                                                      _______       ,   KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_STOP,  KC_MEDIA_NEXT_TRACK,_______       ,
                                                                                    _______       , _______       , _______       , QK_MAKE,          MS_BTN2,     MS_BTN1
    ),
/* .---------------------------------------------. .---------------------------------------------.
 * |       |     |     |     |     |     |       | !       |     |     |     |     |     |       |
 * !-------+-----+-----+-----+-----+-----+-------! !-------+-----+-----+-----+-----+-----+-------!
 ...
 *                                                                      generated by [keymapviz] */
    [SYMB] = LAYOUT_moonlander(
        ...
        EE_CLR,  _______, _______, RM_SPDD, RM_SPDU,          RM_NEXT,           RM_TOGG,          _______, KC_DOT,  KC_0,    KC_EQL,  _______,
                                            RM_VALD, RM_VALU, TOGGLE_LAYER_COLOR,_______, RM_HUED, RM_HUEU
    ),
/* .---------------------------------------------. .---------------------------------------------.
 * |LED_LEV|     |     |     |     |     |       | !       |     |     |     |     |     |QK_BOOT|
 * !-------+-----+-----+-----+-----+-----+-------! !-------+-----+-----+-----+-----+-----+-------!
